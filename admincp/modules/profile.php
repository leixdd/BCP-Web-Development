 ...
 */
?>
<h1 class="page-header">Edit College Profile</h1>
<?php
$CMS = new Cms();
...
if($CMS->isNewsDirWritable()) {
	...
	if(check_value($_POST['news_submit'])) {
		$CMS->cacheCMS('profile',$_POST['news_content']);
	}

	$loadCmsCache = $CMS->LoadCachedCms('profile');
...
?>
		<form role="form" method="post">
			<div class="form-group">
				...
				<label for="input_1">College Profile</label>
			</div>
			<div class="form-group">
